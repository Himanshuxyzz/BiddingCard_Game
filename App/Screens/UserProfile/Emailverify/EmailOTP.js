...
const EmailOTP = () => {
  return (
    ...
    <View style={styles.Otpbox}>
      <Text style={{color:"#FFFFFF", fontSize:15,fontWeight:"700", top:20, textAlign:"center", }}>Enter OTP, Check your Mail</Text>
    ...
    <TouchableOpacity
        ...
        <View style={styles.account}>
            <Text style={{color:"#FFFFFF" , marginVertical:-200}}>Already have an account?</Text>
            <Text style={{color:"#FFFFFF", color:"#389AF4", marginVertical:-200}}>Login</Text>
        </View>
        </ScrollView>
      </View>
  )
