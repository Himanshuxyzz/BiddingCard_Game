...
const Phoneotptryagain = () => {
  return (
    ...
    <Text style={{color:"#F57676", textAlign:"center",fontSize:23, fontWeight:"700", top:10}}>Try again!</Text>
      <Text style={{color:"#FFFFFF", fontSize:13,fontWeight:"500", top:20, textAlign:"center", }}>Oops, Seems like something is <Text style={{color:"#F57676"}}>Wrong</Text></Text>
      ...
      <View>
                      <TouchableOpacity 
                         ...
                         <Text style={styles.verify} >Re-Enter</Text>
                      </TouchableOpacity>
                     </View>
    </View>
...
export default Phoneotptryagain
