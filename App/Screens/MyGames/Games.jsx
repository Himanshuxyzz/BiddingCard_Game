...
const Games = ({ navigation }) => {
  ...
  return (
    <View
      style={[
        styles.container,
        activeTab === "Own Clubs" && styles.ownClubsContainer,
      ]}
    >
      ...
      <Tab.Navigator
        screenOptions={({ route }) => ({
          ...
          tabBarIndicatorStyle: {
            backgroundColor:
              activeTab === "System Generated" ? "#FF92CB" : "#F0BDCA",
          },
        })}
        screenListeners={{
          state: (e) => {
      ...
      >
        <Tab.Screen name="Games" component={MainScreen} />
